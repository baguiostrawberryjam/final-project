        ...
        onValue(ref(db, `users/${user.uid}/projects`), (snapshot) => {
          ...
          if (projectsData) {
            ...
            Object.keys(projectsData).forEach((projectKey) => {
              onValue(ref(db, `users/${user.uid}/projects/${projectKey}/tasks`), (taskSnapshot) => {
                counts[projectKey] = taskSnapshot.exists() ? Object.keys(taskSnapshot.val()).length : 0;
              ...
              <div key={key} className='project-card'>
                <div className="project-card-header">
                  <div
                    ...
                    style={{ backgroundColor: projects[key].folderColor || '#3b82f6' }}
                  />
                ...
                <div className="project-footer">
                  ...
                  <p className="project-task-count">{taskCounts[key] || 0} Tasks</p>
                </div>
              </div>
